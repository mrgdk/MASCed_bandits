...
class Test_egreedy(unittest.TestCase):
    def test_egreedy_normal_simple1(self):
        ...
        result = start(myMock)
        self.assertEqual(result, generate_result(seed1, normal_simple1, "egreedy", 0.3))
    
    def test_egreedy_normal_simple2(self):
        myMock = Mock(ROUNDS, seed2, "egreedy", 0.1)
        myMock.init_arms(normal_simple2)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed2, normal_simple2, "egreedy", 0.1))
    
    def test_egreedy_binomial_simple1(self):
        myMock = Mock(ROUNDS, seed3, "egreedy", 0.2)
        myMock.init_arms(binomial_simple1)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed3, binomial_simple1, "egreedy", 0.2))
    ...
    def test_EwS(self):
        ...
        myMock.init_arms(normal_simple1)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed1, normal_simple1, "EwS", ""))

    def test_EXP3(self):
        myMock = Mock(ROUNDS, seed1, "EXP3", 0.5)
        myMock.init_arms(binomial_simple2)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed1, binomial_simple2, "EXP3", 0.5))
    ...
    def test_EXP3S(self):
        ...
        myMock.init_arms(binomial_simple2)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed3, binomial_simple2, "EXP3S", 0.6))
    ...
    def test_EXP4(self):
        ...
        myMock.init_arms(binomial_simple2)
        result = start(myMock)
        self.assertEqual(result, generate_result(seed3, binomial_simple2, "EXP4", 0.9))
